...
onMounted(async () => { const category = route.query.category; if (typeof category === 'string' && ['attraction', 'culture', 'shopping'].includes(category)) await tourStore.changeCategory(category as 'attraction' | 'culture' | 'shopping'); else await tourStore.fetchTours() })
</script>
